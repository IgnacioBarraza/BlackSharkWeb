          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-16">
              <div className="space-y-8">
                ...
                Si tienes habilidades que crees que podrían complementar
                nuestro equipo, tienes alguna duda o necesitas contactarte
                con nosotros, no dudes en ponerte en contacto. Estamos
                comprometidos en brindar una buena solución a cualquier
                inquietud. ¡Esperamos escuchar de ti pronto y explorar
