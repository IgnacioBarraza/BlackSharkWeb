...
export const Homepage = () => {
    return (
      ...
      <div className=" bg-[url(/homepage1.jpeg)] bg-cover bg-center bg-no-repeat w-full h-screen overflow-hidden overflow-y-auto">
        <div className="flex justify-center items-center h-full">
            <div className="flex flex-col justify-center space-y-8 items-center bg-black bg-opacity-50 p-8 rounded w-1/2 fade-in">
