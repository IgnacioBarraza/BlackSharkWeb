...
function AboutBlackShark() {
  return (
    <div className='flex xl:space-x-28 py-36 max-xl:flex-col max-xl:items-center max-xl:w-full'>
      <img
      ...
      />
      <article className='max-sm:w-full w-[600px] space-y-2 text-lg px-2'>
        <h2 className='text-5xl font-semibold max-xl:text-5xl'>
